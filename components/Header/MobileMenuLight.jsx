...
const MobileMenuLight = ({ subMenuData, navLinksData }) => {
  return (
    <Transition
      as={Fragment}
    ...
    >
      ...
      >
        <div className="divide-y-2 divide-rose-500 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
          <div className="px-5 pt-5 pb-6">
            <div className="flex items-center justify-between">
              <div>
                <WebsiteLogoSvg className="h-8 w-auto fill-black" />
              </div>
              <div className="-mr-2">
                <Popover.Button className="inline-flex items-center justify-center rounded-md bg-white p-2 text-black hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-rose-500">
...
export default MobileMenuLight;
